...
extern const char WEECHAT_DBUS_OBJECT_ROOT[];

/* Signals */
extern const char WEECHAT_DBUS_OBJECT_SIGNAL[];
extern const char WEECHAT_DBUS_OBJECT_SIGNAL_RELATIVE[];

extern const char WEECHAT_DBUS_IFACE_SIGNAL_IRC[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_IN[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_IN[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_OUT[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_OUT[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_CTCP[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_CTCP[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_DCC[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_DCC[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_PV[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_PV[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_SERVER_CONNECTING[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_SERVER_CONNECTING[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_SERVER_CONNECTED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_SERVER_CONNECTED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_SERVER_DISCONNECTED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_SERVER_DISCONNECTED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_NOTIFY_JOIN[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_NOTIFY_JOIN[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_NOTIFY_QUIT[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_NOTIFY_QUIT[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_NOTIFY_AWAY[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_NOTIFY_AWAY[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_NOTIFY_STILL_AWAY[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_NOTIFY_STILL_AWAY[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_IRC_NOTIFY_BACK[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_IRC_NOTIFY_BACK[];

extern const char WEECHAT_DBUS_IFACE_SIGNAL_CORE[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_CORE_DAY_CHANGED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_CORE_DAY_CHANGED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_CORE_PLUGIN_LOADED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_CORE_PLUGIN_LOADED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_CORE_PLUGIN_UNLOADED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_CORE_PLUGIN_UNLOADED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_CORE_QUIT[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_CORE_QUIT[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_CORE_UPGRADE[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_CORE_UPGRADE[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_CORE_HIGHLIGHT[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_CORE_HIGHLIGHT[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_CORE_PV[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_CORE_PV[];

extern const char WEECHAT_DBUS_IFACE_SIGNAL_XFER[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_XFER_ADD[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_XFER_ADD[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_XFER_SEND_READY[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_XFER_SEND_READY[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_XFER_ACCEPT_RESUME[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_XFER_ACCEPT_RESUME[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_XFER_SEND_ACCEPT_RESUME[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_XFER_SEND_ACCEPT_RESUME[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_XFER_START_RESUME[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_XFER_START_RESUME[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_XFER_RESUME_READY[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_XFER_RESUME_READY[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_XFER_ENDED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_XFER_ENDED[];
...
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_SCRIPT_LOADED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SCRIPT_UNLOADED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_SCRIPT_UNLOADED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SCRIPT_INSTALLED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_SCRIPT_INSTALLED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SCRIPT_REMOVED[];
extern const char WEECHAT_DBUS_MEMBER_SIGNAL_SIG_SCRIPT_REMOVED[];

/* Methods */
extern const char WEECHAT_DBUS_OBJECT_CORE[];
extern const char WEECHAT_DBUS_OBJECT_CORE_RELATIVE[];
extern const char WEECHAT_DBUS_IFACE_CORE[];
extern const char WEECHAT_DBUS_MEMBER_CORE_INFOGET[];
extern const char WEECHAT_DBUS_MEMBER_CORE_SIGIN_INFOGET[];
extern const char WEECHAT_DBUS_MEMBER_CORE_SIGOUT_INFOGET[];
extern const char WEECHAT_DBUS_MEMBER_CORE_COMMAND[];
extern const char WEECHAT_DBUS_MEMBER_CORE_SIGIN_COMMAND[];
extern const char WEECHAT_DBUS_MEMBER_CORE_SIGOUT_COMMAND[];
extern const char WEECHAT_DBUS_MEMBER_CORE_GET_BUFFERS[];
extern const char WEECHAT_DBUS_MEMBER_CORE_SIGIN_GET_BUFFERS[];
extern const char WEECHAT_DBUS_MEMBER_CORE_SIGOUT_GET_BUFFERS[];
